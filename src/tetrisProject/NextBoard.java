...
public class NextBoard extends Object {

	private final int width;
    private final int height;
    private BufferedImage[][] nextMatrix;
    private final NextBoardComponent component;
    private Game game;
    public int combo = 0;

    public NextBoard(Game game, int width, int height) {
        this.width = width;
        this.height = height;
        this.nextMatrix = new BufferedImage[height][width];
        this.component = new NextBoardComponent();
        this.game = game;
        clear();
    }
    ...
    private class NextBoardComponent extends JComponent {
        ...
        private void paintSquare(Graphics g, int x, int y) {
            BufferedImage image = nextMatrix[y][x];
